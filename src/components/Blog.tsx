...
const Blog = () => {
  ...
  return (
    <section id="blog" className={`py-20 bg-gray-50 ${isExiting ? 'fade-exit' : 'fade-enter'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
            Laatste Nieuws & Inzichten
              ...
              <div className="relative h-48 bg-gray-200">
                <img
                  ...
                  onError={(e) => {
                    ...
                    target.src = 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80';
                  }}
                />
